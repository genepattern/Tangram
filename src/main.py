...
def main():
  ...
  # Output filename arguments (most replaced by output tag parameter but are commented out for reference)
  ...
  # Filename for testing data matrix
  parser.add_argument("--test_data_filename", help="filename for testing data matrix")
  ...
  parser.add_argument("--deconv_cell_density_plot_filename", help="filename for output plot of cell density (for deconvolution)")
  ...
  # Filename for plot of cell typing (when doing deconvolution)
  parser.add_argument("--deconv_segmentation_data_filename", help="filename for output matrix of segmentation results (for deconvolution)")
